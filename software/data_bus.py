...
#-- Instantiate subsystems
    ...
    the_interfacer = Interfacer(sensor_data_in=interfacer_receive_sensor_data, set_points_out=interfacer_send_set_points)
    the_controller = Controller(sensor_data_in=controller_receive_sensor_data, set_points_in=controller_receive_set_points)
    the_logger = Logger(sensor_data_in=logger_receive_sensor_data, set_points_in=logger_receive_set_points)
    the_notifier = Notifier(sensor_data_in=notifier_receive_sensor_data, set_points_in=notifier_receive_set_points)
